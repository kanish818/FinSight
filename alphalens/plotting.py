...
def plotting_context(context='notebook', font_scale=1.5, rc=None):
    """
    Create FinSight default plotting style context.
    ...
    Example
    -------
    with FinSight.plotting.plotting_context(font_scale=2):
        FinSight.create_full_tear_sheet(..., set_context=False)
...
def axes_style(style='darkgrid', rc=None):
    """Create FinSight default axes style context.
    ...
    Example
    -------
    with FinSight.plotting.axes_style(style='whitegrid'):
        FinSight.create_full_tear_sheet(..., set_context=False)
